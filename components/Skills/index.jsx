    ...
    <section className="skills">
        <div className="skills__inner container">
            ...
            <Skill
                ...
                content="I work incrementally, delivering the most valuble things early and often, rather than waiting until the end of the project. This means I can continuously incorporate user and stakeholder feedback, reducing risk."
                />
        </div>
    </section>
